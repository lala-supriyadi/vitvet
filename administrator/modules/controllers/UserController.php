...
class UserController extends MainController {
    ...
    //     $data = $this->user->getJoin('role',
    //         array(
    //             'artikel.id_role' => 'kategori.id_role'
    //         ),
    //         'JOIN' 
    //     );
    ...
    public function delete() {
        ...
        if(file_exists('../public/images/user/' . $artikel[0]->images)) {

            unlink('../public/images/user/' . $artikel[0]->images);
        }
        $delete = $this->user->delete(array('id_user' => $id));
    ...
    public function insert() {
        ...
        if($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if(empty($role) || $role == "") {
                ...
                array_push($error, "Role harus di isi.");
            }
    ...
    //     $success    = null;
        ...
        $this->template('frmUser', array('user' => $data[0], 'error' => $error, 'success' => $success, 'title' => 'Edit User'));
