...
class ArtikelController extends MainController {
    ...
    public function insert() {
        ...
        $this->template('frmArtikel', array('kategori' => $data,'error' => $error, 'success' => $success, 'title' => 'Tambah Informasi'));
    ...
    public function update() {
        ...
        $this->template('frmArtikel', array('kategori' => $data, 'artikel' => $artikel[0], 'error' => $error, 'success' => $success, 'title' => 'Edit Informasi'));
