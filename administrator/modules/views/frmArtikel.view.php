<div class="row">
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php SITE_URL; ?>?page=artikel"><i class="fa fa-newspaper-o"></i> Informasi</a></li>
        ...
        <form method="post" role="form" enctype="multipart/form-data">
            <table class="table-responsive table">
                ...
                <tr>
                    <td></td>
                    <td></td>
                    <td><button type="submit" class="btn btn-primary">Submit</button> <a class="btn btn-warning" href="<?php echo PATH; ?>?page=artikel">Kembali</a> </td>
                </tr>
                </tbody>
