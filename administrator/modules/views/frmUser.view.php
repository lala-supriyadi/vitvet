    ...
    <div class="col-lg-12">
        ...
        <form method="post" role="form" enctype="multipart/form-data">
            <table class="table-responsive table">
                ...
                <tr>
                    <td style="width: 200px;"><label>Role</label></td>
                    <td style="width: 1px;">:</td>
                    <td>
                            ...
                            <?php
                                foreach($data["role"] as $role) {
                                    ...
                                    <option <?php if(isset($data["user"])){
                                        if($data["user"]->id_role == $role->id_role) echo 'selected';
                                    }
                                    ?> value="<?php echo $role->id_role; ?>"><?php echo $role->nama_role; ?></option>
                                <?php
                                }
                            ?>
                        </select>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class="btn btn-warning" href="<?php echo PATH; ?>?page=user">Kembali</a> </td>
                </tr>
                </tbody>
